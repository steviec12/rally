...
export default async function MyRequestsPage() {
  ...
  const statusStyles: Record<JoinRequestStatus, { bg: string; border: string; color: string }> = {
    pending: {
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    >
                      Your request to{' '}
                      <span style={{ color: 'var(--text-primary)' }}>{n.activity.title}</span> was{' '}
        ...
        {requests.length === 0 ? (
          ...
          >
            {requests.map((req) => {
              ...
              const formattedDate = req.activity.dateTime.toLocaleString('en-US', {
                weekday: 'short',
                month: 'short',
                day: 'numeric',
                hour: 'numeric',
